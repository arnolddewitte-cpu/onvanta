export const seoMeta = {
  nl: {
    home: { title: 'Nieuwe medewerkers, sneller productief', description: 'Gestructureerde onboarding met at-risk detectie voor groeiende MKB-teams.' },
    pricing: { title: 'Prijzen', description: '€24,99 per actieve onboardee. Managers gratis. 14 dagen gratis proberen.' },
    faq: { title: 'Veelgestelde vragen', description: 'Antwoorden over Onvanta, onboarding, prijzen en privacy.' },
    about: { title: 'Over ons', description: 'Onvanta is gebouwd voor Nederlandse MKB-bedrijven.' },
  ...
  en: {
    ...
    pricing: { title: 'Pricing', description: '€24.99 per active onboardee. Managers free. 14-day free trial.' },
    faq: { title: 'FAQ', description: 'Answers about Onvanta, onboarding, pricing and privacy.' },
    about: { title: 'About', description: 'Onvanta is built for Dutch SMBs.' },
