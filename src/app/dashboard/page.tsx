  ...
  return (
    <main className="min-h-screen bg-gray-50">
      <div className="max-w-4xl mx-auto px-6 py-8">
        ...
        {/* Voltooid banner + certificaat */}
        {instance.status === 'completed' && (
          <div className="bg-green-50 border border-green-200 rounded-2xl p-5 mb-6 flex items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              <span className="text-2xl">🎓</span>
              <div>
                <p className="font-semibold text-green-900 text-sm">Onboarding voltooid!</p>
                <p className="text-xs text-green-700 mt-0.5">Je hebt de volledige onboarding succesvol afgerond.</p>
              </div>
            </div>
            <a
              href="/api/me/onboarding/certificate"
              download
              className="flex-shrink-0 flex items-center gap-2 bg-green-600 text-white text-sm font-medium px-4 py-2 rounded-xl hover:bg-green-700 transition-colors"
            >
              <span>⬇</span>
